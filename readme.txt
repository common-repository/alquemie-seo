=== Alquemie SEO ===
Contributors: b2foundry, alquemie
...
1. Upload the `alquemie-seo` folder to the `/wp-content/plugins/` directory
2. Activate the Alquemie SEO plugin through the 'Plugins' menu in WordPress
3. Configure the plugin by going to the `Alquemie SEO` menu that appears in your admin menu

== Frequently Asked Questions ==

== Screenshots ==
Checkout some screenshots of our new Alquemie SEO Plugin.
...
== Changelog ==
= 2.01 =
* Forked from B2 SEO version 2.0
