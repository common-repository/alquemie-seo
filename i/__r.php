...
class au_r{
        ...
        if(is_singular()){ 
            ...
            if(is_home() && 'posts' == get_option('show_on_front') && isset($_os['_hmd_'])){
                ...
                if(($_mds == '' || !$_mds) && isset($_os['_'.$post->post_type.'-m-d_']))
                    ...
                    $_mds = _gtm($_tm, $_tm->taxonomy, 'au_de_');
    ...
    function __mkw(){
        ...
        if(is_singular()){ 
            ...
            if(is_home() && 'posts' == get_option('show_on_front') && isset($_os['_hmkw_'])){
                ...
                $_mk = _gtm($_t, $_t->taxonomy, 'au_mk_');
    ...
    function __rbt(){
        ...
        if(is_singular()){
            ...
            if(is_tax() || is_tag() || is_category()){
                $_t = $wp_query->get_queried_object();
                if(_gtm($_t, $_t->taxonomy, 'au_noi_'))
                    $_r['i'] = 'noindex';
                if(_gtm($_t, $_t->taxonomy, 'au_nof_'))
                    $_r['f'] = 'nofollow';
             }
        }
    ...
    function __t($_t, $_s = '|', $_sl = '', $_p = ''){
        ...
        if(is_home() && 'posts' == get_option('show_on_front')){
            ...
            $_t = trim(_gtm($_m, $_m->taxonomy, 'au_tt_'));
            if(!$_t || empty($_t)){
