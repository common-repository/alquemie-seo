<?php
if(!class_exists('au_a')){
    class au_a extends au_c{
        var $_mt = 'Alquemie SEO';
        var $_pt = 'Alquemie SEO Plugin';
        var $_ic = 'icon.png';
        var $_hk = 'seo';
        var $_fl = 'SEO/seo.php';
        ...
        var $_df = 'au_seo';
        function au_a(){
            add_action('init', array(&$this, 'au_x'));
        }
        function au_x(){
        ...
        function _sop() {
            register_setting('au_seo_global_options', 'au_seo');
            register_setting('au_seo_global_options_t', 'au_seo_t');
            register_setting('au_seo_global_options_p', 'au_seo_p');
            register_setting('au_seo_global_options_i', 'au_seo_i');
            register_setting('au_seo_global_options_n', 'au_seo_n');
            register_setting('au_seo_global_options_r', 'au_seo_r');
            register_setting('au_seo_global_options_3', 'au_seo_3');
            register_setting('au_seo_global_options_b', 'au_seo_b');
            register_setting('au_seo_global_options_h', 'au_seo_h');
            register_setting('au_seo_global_options_w', 'au_seo_w');
            register_setting('au_seo_global_options_f', 'au_seo_f');
            register_setting('au_seo_global_options_c', 'au_seo_c');
            register_setting('au_seo_global_options_e', 'au_seo_e');
        }
        function _pbe() {
            $_os = get_option('au_seo');
        ...
        function _stc($_ct, $_h = false, $_f = true, $_o = 'au_seo_global_options', $_k = 'au_seo', $_fl = false){
            ?>
            <div class="wrap">
                <?php 
                ...
                $_x = get_option('au_seo');
                if(!empty($_x) && is_array($_x)){
                    /* Authenticate!! */
                }
                ?>
                <a href="http://b2foundry.com/"><div id="b2-icon" style="background: url(<?php echo AU_SEO_URL; ?>/css/images/au_32.png) no-repeat;" class="icon32"><br /></div></a>
                <h2><?php echo "Alquemie SEO: ".$_ct; ?></h2>
        ...
        function _g_ttp(){
            $this->_stc('Title Tag Settings', false, true, 'au_seo_global_options_t', 'au_seo_t');
            $_os = _gso();
            $_h = '<p>In order to enable Alquemie SEO to modify your site titles, the <code>title</code> tag in your <code>header.php</code> file should look like this:</p>';
            ...
            $_h .= '<p>You may want to set titles and information for individual pages and posts.  To do that fill, out the Alquemie SEO area on that page or post.  To create a template to use on all other pages and posts, fill out the area below</p>';
        ...
        function _g_plp() {
            ...
            $this->_stc('Permalinks', true, true, 'au_seo_global_options_p', 'au_seo_p');
        ...
        function _g_inp() {
            $this->_stc('Indexing', true, true, 'au_seo_global_options_i', 'au_seo_i');
        ...
        function _g_nfp(){
            $this->_stc('Follow/NoFollow Rules', true, true, 'au_seo_global_options_n', 'au_seo_n');
        ...
        function _g_rsp(){
            $this->_stc('Robot Settings', true, true, 'au_seo_global_options_r', 'au_seo_r');
        ...
        function _g_301p(){
            $this->_stc('301 Redirects', true, true, 'au_seo_global_options_3', 'au_seo_3');
        ...
        function _g_bcp() {
            $this->_stc('Breadcrumbs', false, true, 'au_seo_global_options_b', 'au_seo_b');
            ...
            $_h .= '<pre>&lt;?php if(function_exists(&#x27;au_breadcrumbs&#x27;)){
        ...
        function _g_chp(){
            $this->_stc('Head Tag Cleaner', true, true, 'au_seo_global_options_h', 'au_seo_h');
        ...
        function _g_wbp(){
            $this->_stc('Webmaster Tools', false, true, 'au_seo_global_options_w', 'au_seo_w');
        ...
        function _g_fdp() {
            $_os = _gso();
            $this->_stc('RSS Settings', false, true, 'au_seo_global_options_f', 'au_seo_f');
            ...
            $_r[] = array(
                ...
                "_d" => "(HTML allowed)",
                "_c" => '<textarea cols="50" rows="5" id="_rbf_" name="au_seo_f[_rbf_]">'.$_rbf.'</textarea>',
            );
            $_r[] = array(
                "_i" => "_raf_",
                "_l" => "Contents after post in the feed",
                "_d" => "(HTML allowed)",
                "_c" => '<textarea cols="50" rows="5" id="_raf_" name="au_seo_f[_raf_]">'.$_raf.'</textarea>',
            );
            $_r[] = array(
                "_l" => 'Help',
        ...
        function _g_cip(){
            $this->_stc('Custom Code Inserter', true, true, 'au_seo_global_options_c', 'au_seo_c');
        ...
        function _g_fep(){
            $this->_stc('File Editor', true, true, 'au_seo_global_options_e', 'au_seo_e');
        ...
        function _g_bkp(){
            ...
            $_h .= '<form method="post">';
            $_h .= '<p>Backup your Alquemie SEO settings.</p>';
            $_h .= '<input type="submit" class="button" name="au_seo_exp" value="Backup Settings"/>';
            $_h .= '</form>';
            if ( isset($_POST['au_seo_exp']) ) {
                $_itm_ = false;
                $_u = _exps();
                if($_u){
                    ...
                    if($_uz[0]['stored_filename'] == 'b2seo.ini'){
                        ...
                        foreach($_ss as $_k => $_v) {
                            if($_k != 'au_seo_m') {
                                ...
                                update_option($_k, json_decode(urldecode($_v['au_seo_m']), true));
                            }
                        }
        ...
        function _g_gup($_u){
            ...
            $_os = _gso();
            ?>
            <h3 id="seo">Alquemie SEO settings</h3>
