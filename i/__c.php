...
if(!class_exists("au_c")){
    class au_c{
		...
		wp_enqueue_style('wp-admin');
                wp_enqueue_style('tools', AU_SEO_URL . 'css/tools.css');
            }
        }
        function _rp(){
	    add_menu_page($this->_pt, $this->_mt, $this->_lv, 'g', array(&$this,'_g_gsp'), AU_SEO_URL.'/css/images/au_16.png');
	...
	function _ft($_rs){
        ...
        function _wp2ns(){
            $_h = '<p>For any problems or suggestions please contact us at <a href="mailto:support@alquemie.net?subject=[Alquemie SEO Plugin] Report">support@alquemie.net</a>.</p>';
            $this->_cpb($this->_hk.'suggestions', 'Plugin Support', $_h);
        }				function _wpguid(){            $_h = '<a href="http://issuu.com/b2foundry/docs/b2foundry-b2seo-instructions?mode=window&backgroundColor=%23ffffff" target="_blank"><img style="width: 236px; height: auto; display: block; margin: 0 auto;" src="' . AU_SEO_URL . 'b2seo.png" /></a>';            $this->_cpb($this->_hk.'insmanual', 'Alquemie SEO Instruction Manual', $_h);		}
	function _wp2np(){
